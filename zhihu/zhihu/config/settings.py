...
TEMP_WCGROUP_QUEUE = 'haipproxy:wcgroup:temp'
...
VALIDATED_WCGROUP_QUEUE = 'haipproxy:validated:wcgroup'
...
TTL_WCGROUP_QUEUE = 'haipproxy:ttl:wcgroup'
...
SPEED_WCGROUP_QUEUE = 'haipproxy:speed:wcgroup'
